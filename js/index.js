...
} else { console.log("No, Steve is not present");}
...
} else {console.log("There is Not enough power!")}
...
marksAverage = marksTotal / marks.length;
...
} else {console.log("User and Age Do Not Match");}
...
} else {console.log("User is Younger than 18 and is Not Peter");}
